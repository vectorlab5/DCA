...
%% Float placement: keep full-width figures near their callouts.
%% In two-column layout, figure* can only go top-of-page or on a float page;
%% these settings let more of them reach the top rather than deferring to the end.
\setcounter{topnumber}{2}%              up to 2 top floats per page
\setcounter{totalnumber}{3}%
\renewcommand{\topfraction}{0.9}%       a top float may fill 90% of the page
\renewcommand{\dbltopfraction}{0.9}%    same, for full-width (double-column) floats
\renewcommand{\textfraction}{0.08}%     allow pages that are mostly float
